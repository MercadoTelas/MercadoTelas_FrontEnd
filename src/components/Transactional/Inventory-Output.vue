...
<!--
  Componente para registrar salidas de inventario

  Este código representa un componente Vue.js que muestra una lista de artículos y utiliza un modal para la búsqueda de artículos. Aquí está la descripción detallada de cada elemento y directiva en el código:

Estructura del Template
-----------------------

El bloque `<template>` define la estructura del componente utilizando elementos HTML y directivas de Vue.js
...
- `<th class="text-center">Cantidad en unidades de inventario a remover</th>`: Celda de encabezado para la cantidad en unidades de inventario a remover.

- `<th class="text-center">Cantidad en unidades de venta a remover</th>`: Celda de encabezado para la cantidad en unidades de venta a remover.
...
- `<td>`: Celda para el campo "Nombre del artículo". Contiene un campo de entrada de texto enlazado a

la propiedad `item.name`.

- `<td>`: Celda para el campo "Cantidad en unidades de inventario a remover". Contiene una fila con dos columnas. La columna izquierda contiene un campo de entrada numérico enlazado a la propiedad `item.storing_format_units`. La columna derecha muestra el nombre del formato de unidad de almacenamiento.

- `<td>`: Celda para el campo "Cantidad en unidades de venta a remover". Contiene una fila con dos columnas. La columna izquierda contiene un campo de entrada numérico enlazado a la propiedad `item.transferring_format_units`. La columna derecha muestra el nombre del formato de unidad de transferencia.

- `<td>`: Celda para las acciones. Contiene un botón "Eliminar" que invoca el método `removeItem`.

- `<button @click="removeItem(index)" class="btn btn-danger">Eliminar</button>`: Botón para eliminar el artículo de la tabla. Invoca el método `removeItem` cuando se hace clic en él.
